...
def science_mode():
    ...
    button_22 = Button(win, text='sin', command=lambda: fill('sin('), width=15)
    button_22.grid(column=5, row=1)
    button_23 = Button(win, text='cos', command=lambda: fill('cos('), width=15)
    button_23.grid(column=6, row=1)
    button_24 = Button(win, text='tan', command=lambda: fill('tan('), width=15)
    button_24.grid(column=5, row=2)
    button_25 = Button(win, text='阶乘', command=lambda: fill('factorial('), width=15)
    button_25.grid(column=6, row=2)
    button_26 = Button(win, text='π', command=lambda: fill('pi'), width=15)
    button_26.grid(column=5, row=3)
    button_27 = Button(win, text='e', command=lambda: fill('e'), width=15)
    button_27.grid(column=6, row=3)
...
button_21 = Button(win, text='.', command=lambda: fill('.'), width=15)
button_21.grid(column=0, row=5)
main_menu = Menu(win)
